    ...
    <div className="p-6 max-w-5xl mx-auto">
      ...
      {!activeSim ? (
        <div className="grid md:grid-cols-3 gap-6">
          ...
          >
            <div className="w-12 h-12 bg-orange-900/50 rounded-lg flex items-center justify-center text-orange-400 mb-4 group-hover:scale-110 transition-transform">
              <WifiOff size={24} />
            </div>
          ...
          >
            <div className="w-12 h-12 bg-red-900/50 rounded-lg flex items-center justify-center text-red-400 mb-4 group-hover:scale-110 transition-transform">
              <Zap size={24} />
            </div>
        ...
        <div>
          <button 
            ...
            className="mb-4 text-blue-400 hover:text-blue-300 text-sm font-medium"
          >
