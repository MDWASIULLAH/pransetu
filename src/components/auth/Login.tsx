    ...
    <div className="bg-surface text-on-surface min-h-screen flex items-center justify-center relative overflow-hidden selection:bg-primary selection:text-on-primary font-sans w-full p-4">
      ...
      <main className="relative z-20 w-full max-w-[420px] px-4 md:px-0 py-8">
        ...
        <div className="bg-surface-container/90 backdrop-blur-sm border border-outline-variant/30 rounded-xl shadow-lg overflow-hidden flex flex-col">
          ...
          <div className="p-6 md:p-8 flex flex-col gap-5">
            ...
            <div className="text-center flex flex-col items-center gap-1">
              <div className="w-12 h-12 rounded-lg bg-surface-container-lowest border border-outline-variant/30 flex items-center justify-center mb-2 shadow-inner">
            ...
            <div className="bg-error-container/20 border border-error-container/50 rounded-lg p-3 flex items-start gap-3">
              <span className="material-symbols-outlined text-error mt-0.5 text-[20px] shrink-0">
                warning
              </span>
              <p className="text-sm text-xs text-on-error-container leading-relaxed">
                ...
                <label className="flex items-center gap-2 cursor-pointer group">
                  <div className="relative flex items-center justify-center">
                    <input
                      ...
                      className="peer appearance-none w-4 h-4 border border-outline-variant/30 rounded bg-surface-container-lowest checked:bg-primary checked:border-primary focus:outline-none focus:ring-2 focus:ring-primary/50 transition-colors cursor-pointer"
                      type="checkbox"
                    />
                    <span className="material-symbols-outlined absolute text-[14px] text-on-primary opacity-0 peer-checked:opacity-100 pointer-events-none">
                      check
                    </span>
                  </div>
                  <span className="text-sm text-xs text-on-surface-variant group-hover:text-on-surface transition-colors">
        ...
        <div className="mt-6 text-center opacity-60 flex flex-col items-center gap-1">
          <p className="text-xs text-[11px] text-on-surface-variant uppercase font-sans">
            J-NET Node: Alpha-Prime // SysStatus: Optimal
          </p>
          <p className="text-sm text-[11px] text-on-surface-variant">
