...
const initialShelters: ShelterFacility[] = [
  {
    ...
    lng: 85.8830,
    tier: 'Tier 2 - Urgent',
    tierColor: 'bg-[#F59E0B] text-black',
    tierText: 'Tier 2 - Urgent',
    borderColor: 'bg-[#F59E0B]',
    occupancyColor: 'bg-[#DC2626]',
    capacity: 850,
    occupied: 782,
  ...
  },
  {
    ...
    lng: 85.8245,
    tier: 'Tier 1 - Basic',
    tierColor: 'bg-[#10B981] text-black',
    tierText: 'Tier 1 - Basic',
    borderColor: 'bg-[#10B981]',
    occupancyColor: 'bg-[#10B981]',
    capacity: 3200,
    occupied: 1440,
  ...
  },
  {
    ...
    tierColor: 'bg-[#DC2626] text-white',
      ...
      prev.map((s) => {
        if (s.id === shelterId || s.name === shelterId) {
          ...
          return {
            ...
            tierColor: pct > 90 ? 'bg-[#DC2626] text-white' : pct > 70 ? 'bg-[#F59E0B] text-black' : 'bg-[#10B981] text-black',
            borderColor: pct > 90 ? 'bg-[#DC2626]' : pct > 70 ? 'bg-[#F59E0B]' : 'bg-[#10B981]'
          };
        }
        return s;
      })
